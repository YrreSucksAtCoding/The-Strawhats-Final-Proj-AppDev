...
Tutorial on how to run this locally and when we host - Yrre
...
3. Check `includes/config.php` — the defaults match XAMPP (`root`, empty password, `http://localhost/worknest` or whatever your pathing is).
...
├── includes/            phpmailer, config, helpers, header, footer
├── assets/              css, products, logo
